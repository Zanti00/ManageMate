...
export default function AdminEditEvent({ event }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <div className="flex flex-col gap-4 p-8">
                ...
                <Heading
                    title="Edit Event"
                    description="Update the event details and save your changes"
                />
                <Card className="flex h-full flex-col gap-y-6 p-6 shadow-md">
